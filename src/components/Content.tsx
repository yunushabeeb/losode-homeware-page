        ...
        <a
          ...
          className={clsx(
            variant === 'trends' || variant === 'hero'
              ? index !== 1
                ? 'py-2 px-4 bg-black text-white hover:bg-white hover:text-black hover:border-2 border-black text-base w-[254px] text-center flex items-center justify-center mr-auto'
            ...
            variant === 'product-caption' &&
              ' no-underline py-2 px-4 text-[#000] bg-white w-[254px] text-center',
          )}
        >
          {buttonText}
        </a>
